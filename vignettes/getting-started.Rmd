...
# The package ships demo R source files in inst/extdata/demo/ -- these are
# always present after installation, so build_rrlm_graph() always finds real
# function nodes and produces a meaningful graph for the examples below.
demo_dir <- system.file("extdata", "demo", package = "rrlmgraph")

# Also create a small temp project for the incremental-update demo (§5).
