...
#' @importFrom igraph incident induced_subgraph layout_in_circle layout_with_kk
#' @importFrom igraph make_empty_graph neighborhood neighbors page_rank
#' @importFrom igraph plot.igraph vcount vertex_attr
