...
#> Done in 0.65s -- 27 nodes, 11 edges
```
...
#> 
#> Changed files: /tmp/RtmpSOPLUR/mypkg_demo/R/data_prep.R
#> Removing 1 stale node(s).
#> Re-parsing 1 file(s).
#> Embedding 1 new node(s) using method 'tfidf'.
#> Graph now has 2 nodes, 0 edges.
#> Recomputing PageRank.
#> Persisting cache to /tmp/RtmpSOPLUR/mypkg_demo.
#> Graph cached at /tmp/RtmpSOPLUR/mypkg_demo/.rrlmgraph

summary(graph_small)
#> IGRAPH 6a69eec DNW- 2 0 -- 
