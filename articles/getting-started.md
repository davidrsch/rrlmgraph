...
#> 
#> Changed files: /tmp/Rtmp4fDWKa/mypkg_demo/R/data_prep.R
#> Removing 1 stale node(s).
#> Re-parsing 1 file(s).
#> Embedding 1 new node(s) using method 'tfidf'.
#> Graph now has 2 nodes, 0 edges.
#> Recomputing PageRank.
#> Persisting cache to /tmp/Rtmp4fDWKa/mypkg_demo.
#> Graph cached at /tmp/Rtmp4fDWKa/mypkg_demo/.rrlmgraph

summary(graph_small)
#> IGRAPH ea344d2 DNW- 2 0 -- 
