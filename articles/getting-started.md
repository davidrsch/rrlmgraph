...
#> Done in 0.59s -- 22 nodes, 11 edges
```
...
#> 
#> Changed files: /tmp/Rtmpea1GnM/mypkg_demo/R/data_prep.R
#> Removing 1 stale node(s).
#> Re-parsing 1 file(s).
#> Embedding 1 new node(s) using method 'tfidf'.
#> Graph now has 2 nodes, 0 edges.
#> Recomputing PageRank.
#> Persisting cache to /tmp/Rtmpea1GnM/mypkg_demo.
#> Graph cached at /tmp/Rtmpea1GnM/mypkg_demo/.rrlmgraph

summary(graph_small)
#> IGRAPH 0e11b87 DNW- 2 0 -- 
