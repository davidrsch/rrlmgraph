...
#> Done in 0.64s -- 27 nodes, 11 edges
```
...
#> 
#> Changed files: /tmp/Rtmpqu8n3E/mypkg_demo/R/data_prep.R
#> Removing 1 stale node(s).
#> Re-parsing 1 file(s).
#> Embedding 1 new node(s) using method 'tfidf'.
#> Graph now has 2 nodes, 0 edges.
#> Recomputing PageRank.
#> Persisting cache to /tmp/Rtmpqu8n3E/mypkg_demo.
#> Graph cached at /tmp/Rtmpqu8n3E/mypkg_demo/.rrlmgraph

summary(graph_small)
#> IGRAPH 462b275 DNW- 2 0 -- 
