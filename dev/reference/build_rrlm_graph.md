...
| `"CO_CHANGES"`    | Two functions co-edited in \>= `min_cochanges` commits (from [`build_co_change_edges()`](https://davidrsch.github.io/rrlmgraph/dev/reference/build_co_change_edges.md)) |
| `"DISPATCHES_ON"` | S4/R5 generic dispatches on a class (from [`build_dispatch_edges()`](https://davidrsch.github.io/rrlmgraph/dev/reference/build_dispatch_edges.md))                      |
| `"EXTENDS"`       | Class inherits from another class (from [`build_dispatch_edges()`](https://davidrsch.github.io/rrlmgraph/dev/reference/build_dispatch_edges.md))                        |
